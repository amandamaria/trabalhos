...
public class OverlayMediaPlay {

//    private static final String MEDIA_URL = "http://dw.convertfiles.com/files/0476697001477779984/ramonadeskflix.mp4";
    ...
    public OverlayMediaPlay(String mediaURL) {
		initRoot(mediaURL);
	}

    private void initRoot(String mediaURL) {
        root = new Group();
        ...
        getRoot().getStylesheets().add(getClass().getResource("OverlayMediaPlayer.css").toString());
        getRoot().getChildren().add(playerPane);
    } 
